...
module.exports = async function ({ethers, ...hre}) {
    ...
    const bentobox = (await ethers.getContractFactory("BentoBoxV1")).attach((await deployments.get("BentoBoxV1")).address)
    */
    const bentobox = (await ethers.getContractFactory("BentoBoxV1")).attach("0xF5BCE5077908a1b7370B9ae04AdC565EBd643966")
...
*/
    ...
    /*  const swapper = (await ethers.getContractFactory("SushiSwapSwapperV1")).attach((await deployments.get("SushiSwapSwapperV1")).address)
     */
    const swapper = (await ethers.getContractFactory("SushiSwapSwapperV1")).attach("0x1766733112408b95239aD1951925567CB1203084")
